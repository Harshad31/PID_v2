...
const long readingInterval = 250;  // Interval between readings (500ms)
const long controlCycleInterval = 6000;  // Control cycle time (5000ms)
...
double Kp = 0.8, Ki = 0.4, Kd = 1.6;  // Normal PID parameters
...
void setup() {
  ...
  pidController.SetOutputLimits(0, 1000);  // Limit PID output to control SSR (0-100)
